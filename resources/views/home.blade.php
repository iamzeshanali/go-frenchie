...
<div class="wrapper gf-home-banner-wrapper d-flex justify-content-center p-0">
    <div class="container row align-items-center">
        <div class="gf-home-banner-text col-md-6">
            <p>We Provide The Best Care</p>
            <h1>
                <span style="color:#be202e;">The #1 Place to Buy or Sell</span><br>
                Your Frenchie</h1>
            ...
            <div class="gf-home-banner-button">
                <button class="gf-btn-light mr-4">SELL</button>
                <button class="gf-btn-dark">SEARCH</button>
            </div>
        </div>
