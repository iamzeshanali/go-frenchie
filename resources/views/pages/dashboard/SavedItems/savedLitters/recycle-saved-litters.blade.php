                            ...
                            <table class="bd-content-table table table-striped table-hover">
                                ...
                                @foreach($listings as $list)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#recycleListingModal{{$list->litters->getId()}}" class="edit" data-toggle="modal"><i class="fas fa-pencil-alt"></i></a>
                                            <div id="recycleListingModal{{$list->litters->getId()}}" class="modal fade">
                                                    ...
                                                    <div class="modal-content">
                                                        <form>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{route('recycleTrashedSavedLitters', $list->litters->slug)}}" method="get">
                                                                    @csrf
                                                    ...
                                                    <div class="modal-content">
                                                        <form>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{route('permanentlyDeleteLitters', $list->litters->slug)}}" method="post">
                                                                    @csrf
                                                                    @method('delete')
