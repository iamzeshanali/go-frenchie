                        ...
                        <div class="table-wrapper">
                            <div class="table-title">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <a href="{{route('showTrashedCanineGenetics',1)}}"  class="gf-btn-light">
                                            <i class="fas fa-trash-alt"></i> <span>Recycle Genetics</span>
                                        </a>
                                        <a href="{{route('addCanineGenetics')}}" class="gf-btn-dark">
                                            <i class="fas fa-plus"></i> <span>Add New Genetics</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
