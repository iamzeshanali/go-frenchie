...
@section('content')
    ...
    <div class="container-fluid">
        @if(isset($supply))
            ...
            @endforeach
            <h2 class="page-title text-center mb-5">Edit Canine Genetics</h2>
        @else
            <h2 class="page-title text-center mb-5">Add Canine Genetics</h2>
        @endif
            <div class="page-content">
                ...
                <div class="fbd-create-listing-content-area p-3 mb-3 rounded">
                    ...
                    @if(isset($supply))
                        ...
                        <form method="post" action="{{route('updateCanineGenetics')}}" enctype="multipart/form-data" id="create-listing-form mx-5">
                            @csrf
                            @method('patch')
                    ...
                    @else
                        <form method="post" action="{{route('createCanineGenetics')}}" enctype="multipart/form-data" id="create-listing-form mx-5">
                            @csrf
