                    ...
                    <div class="table-responsive">
                        <div class="table-wrapper">
                            <div class="table-title">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <h2>Trashed Listings <b>Puppies</b></h2>
                                    </div>
                                    <div class="col-sm-6 text-right">
                                        <a href="{{route('deleteAllBreederSupplies')}}" class="gf-btn-dark">
                                                        ...
                                                        <div class="modal-content">
                                                            <form>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form action="{{route('showTrashedSupplies',1)}}" method="get">

                                                                        <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                                                                    </form>

                                                                    <form action="{{route('recycleBreederSupplies', $supply->slug)}}" method="get">
                                                                        @csrf
                                                        ...
                                                        <div class="modal-content">
                                                            <form>
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form action="{{route('deleteBreederSupplies', $supply->slug)}}" method="post">
                                                                        @csrf
                                                                        @method('delete')
