    ...
    <div class="container-fluid">
        <div class="row pb-0">
            <div class="btn-group btn-breadcrumb breadcrumb-info">
                ...
                <a href="{{route('showAllCanineNutrition',1)}}" disabled class="btn btn-info visible-lg-block visible-md-block">Canine Nutrition</a>
            </div>
        </div>
    </div>
    <div class="container-fluid">
        <div class="gf-dashboard-page-content row align-items-start">
            ...
            <div class="fbd-create-listing-content-area col-xl-10 col-lg-9">
                ...
                <form method="post" action="{{isset($supply) ? route('updateCanineNutrition') : route('createCanineNutrition')}}" enctype="multipart/form-data" id="create-listing-form mx-5">
                    @csrf
                    @if(isset($supply))
                        @method('patch')
                    ...
                    <div class="row justify-content-center p-0">
                        <div class="col-md-8">
                            <h2 class="text-center mb-4 gf-red">{{isset($supply) ? 'Update' : 'Add New'}} Canine Nutrition</h2>
                            <div class="col">
                                <input type="text" name="title" value="{{isset($supply) ? $supply->title : ''}}"  class="gf-form-field" id="listing Title" placeholder="Nutrition Name: *" required autofocus >
                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="input-group my-3 flex-nowrap">
                                            @if(isset($supply) && ($supply->logo != null))
                                                ...
                                                <input type="text"  value="{{$img1}}"  class="gf-form-field mb-0 @error('image_one') is-invalid @enderror" disabled placeholder="Upload Nutrition Image" id="main_image" required autofocus>
                                            @else
                                                <input type="text" class="gf-form-field mb-0 @error('image_one') is-invalid @enderror" disabled placeholder="Upload Nutrition Image" id="main_image" required autofocus>
                                            @endif
                                            <div class="">
