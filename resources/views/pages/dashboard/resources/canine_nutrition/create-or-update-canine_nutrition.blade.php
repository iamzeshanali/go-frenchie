...
@section('content')
    ...
    <div class="container-fluid">
        @if(isset($supply))
            ...
            @endforeach
            <h2 class="page-title text-center mb-5">Edit Canine Nutrition</h2>
        @else
            <h2 class="page-title text-center mb-5">Add Canine Nutrition</h2>
        @endif
        <div class="page-content">
            ...
            <div class="fbd-create-listing-content-area p-3 mb-3 rounded">
                ...
                @if(isset($supply))
                    ...
                    <form method="post" action="{{route('updateCanineNutrition')}}" enctype="multipart/form-data" id="create-listing-form mx-5">
                        @csrf
                        @method('patch')
                ...
                @else
                    <form method="post" action="{{route('createCanineNutrition')}}" enctype="multipart/form-data" id="create-listing-form mx-5">
                        @csrf
