                            ...
                            <div class="table-title">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 text-right">
                                        <a href="{{route('deleteAllPuppies')}}" class="gf-btn-dark">
                                                        ...
                                                        <div class="modal-content">
                                                            <form>
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form action="{{route('recyclePuppies', $puppy->slug)}}" method="get">
                                                                        @csrf
                                                        ...
                                                        <div class="modal-content">
                                                            <form>
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form action="{{route('deletePuppies', $puppy->slug)}}" method="post">
                                                                        @csrf
                                                                        @method('delete')
