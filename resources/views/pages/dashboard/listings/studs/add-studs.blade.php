...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @if(isset($puppy))
            <h2 class="page-title text-center mb-5">Edit STUD LISTING</h2>
        @else
                ...
                @if(isset($puppy))
                    <form method="post" action="{{route('updateListing')}}" enctype="multipart/form-data" id="create-listing-form mx-5">
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-sm-3">
                                <input type="checkbox" name="sponsored" @if((bool)$puppy->isSponsored == 1) checked @endif  class="form-control" autofocus>
                            </div>
                        </div>
                        <div class="row my-3">
