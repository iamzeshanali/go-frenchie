                        ...
                        <div class="table-wrapper">
                            <div class="table-title">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <a href="{{route('showTrashedStuds')}}" class="btn btn-success btn-fbd">
                                            <i class="fas fa-trash-alt"></i> <span>Recycle Listing</span>
                                        </a>
                                        <a href="{{route('addStud')}}" class="btn btn-success btn-fbd">
                                ...
                                <div class="clearfix">
                                    ...
                                    <ul class="pagination">
                                        ...
                                        @if(($total % 5) == 0)
                                            ...
                                            @for($i = 1; $i<=($total/5); $i++)
                                                <li class="page-item {{$page == $i ? 'active' : ''}}"><a href="{{\Illuminate\Support\Facades\URL::to('dashboard/studs')}}/{{$i}}" class="page-link">{{$i}}</a></li>
                                            @endfor
                                        @else
                                            ...
                                            @endfor
                                        @endif
                                        <li class="page-item {{$page >= $total/5 ? 'disabled' : '' }}"><a href="{{\Illuminate\Support\Facades\URL::to('dashboard/studs')}}/{{$page+1}}" class="page-link">Next</a></li>
                                    </ul>
                                </div>
                            @endif
