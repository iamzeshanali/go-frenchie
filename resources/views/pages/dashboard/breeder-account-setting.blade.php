                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col">
                                    <div class="input-group mb-0 flex-nowrap">
                                            <label for="b-facebook" class="col-md-1 text-center gf-form-field-inline-icon mb-0"><i class="fab fa-facebook-f"></i></label>
                                ...
                                <div class="row gf-breeder-profile-image align-items-center">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group my-3 flex-nowrap">
                                            <input type="text" class="gf-form-field gf-form-field-inline-left mb-0 @error('image_one') is-invalid @enderror" disabled placeholder="Breeder Profile Image" id="main_image" required autofocus>
                                            <div class="">
