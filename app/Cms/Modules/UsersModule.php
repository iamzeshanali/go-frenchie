...
//            $table->mapProperty(Users::FIRST_NAME)->to(Field::create('first_name', 'First Name')->string()->required());
//            $table->mapProperty(Users::LAST_NAME)->to(Field::create('last_name', 'Last Name')->string()->required());
